...
import com.example.hissesenetleritahmin.databinding.ActivityGuncelleBinding
...
class GuncelleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //realtime database de bulunan kulllanıcının Id'si ne erişme
        ...
        binding.guncellebutton.setOnClickListener {
            ...
            currentUser!!.updateEmail(guncelleemail)
                .addOnCompleteListener {task ->
                    if (task.isSuccessful){
                        ...
                        Toast.makeText(applicationContext,"E-mail başarısız",Toast.LENGTH_LONG).show()
                    }
                }
            //Parola güncelleme
            ...
            currentUser!!.updatePassword(guncelleparola)
                .addOnCompleteListener {task ->
                    if (task.isSuccessful){
                        ...
                        Toast.makeText(applicationContext,"Parola başarısız",Toast.LENGTH_LONG).show()
                    }
                }
            //Ad soyad güncelleme
            ...
            Toast.makeText(applicationContext,"Adı Soyadı güncellendi",Toast.LENGTH_LONG).show()
        }
